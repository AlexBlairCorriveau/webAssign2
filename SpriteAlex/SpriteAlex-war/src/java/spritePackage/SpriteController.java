/**
 * Class name: SpriteCOntroller.java
 * Description: Takes in the user action and performs the requested action
 * 
 * @author alexb
 * @version 1
 * @since 2020/11/17
...
import spritePackage.util.JsfUtil;
import spritePackage.util.PaginationHelper;
...
public class SpriteController implements Serializable {
    ...
    @EJB
    private cst8218.blai0274.entity.SpriteFacade ejbFacade;
    ...
    private cst8218.blai0274.entity.SpriteFacade getFacade() {
        return ejbFacade;
    }
